...
<?php 
    ...
    <header id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
		   ...
		   <center> <h1 style="color:#3399ff;" >Online Feedback System</h1></center>
            <div class="item active">
              
                <div class="fill" style="background-image:url('images/feedback-a.png');"></div>
            ...
            <div class="item">
                <div class="fill" style="background-image:url('images/feedback-b.jpg');"></div>
                <div class="carousel-caption">
			 ...
			 <div class="item">
                <div class="fill" style="background-image:url('images/feedback-c.jpg');"></div>
                <div class="carousel-caption">
